...
The manifest `description` is also shown in the browser’s **Installed extensions** list; keep it aligned with Survey **Hide** / **Show** behavior (see the introduction above), not only suppressing the survey flag.
